...
void VolvoSpaHybridBattery::setup(void) {                     // Performs one time setup at startup
  ...
  datalayer.battery.info.min_cell_voltage_mV = MIN_CELL_VOLTAGE_MV;  datalayer.battery.info.number_of_cells = 102;  datalayer.battery.info.max_cell_voltage_deviation_mV = MAX_CELL_DEVIATION_MV;
}
