...
enum BatteryEmulator_bms_status_enum { STANDBY = 0, INACTIVE = 1, DARKSTART = 2, ACTIVE = 3, FAULT = 4, UPDATING = 5 };
enum BatteryEmulator_real_bms_status_enum { BMS_DISCONNECTED = 0, BMS_STANDBY = 1, BMS_ACTIVE = 2, BMS_FAULT_EMULATOR = 3 };
...
std::string getBMSStatus(BatteryEmulator_bms_status_enum status);
