$file = 'C:\Users\GrahamWillsher\ESP32Projects\espnowreceiver_LCD\src\mqtt\mqtt_client.cpp'
...
# Replace rx stream topics (if any)
...
$remaining = (Select-String 'batt-emu/mqtt-v1' $file | Where-Object { $_.Line -notmatch '(LOG_|^\s*//)' }).Count
$canonical = (Select-String 'mqtt::topics' $file).Count
Write-Host "Done. Remaining functional raw strings: $remaining  |  Canonical references: $canonical"
