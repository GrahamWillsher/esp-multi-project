...
**Exact working code:**
- `espnowreciever_2/src/display/display_splash.cpp` ← Copy from here
- `espnowreciever_2/src/display/display_splash.h`
- `espnowreciever_2/src/config/littlefs_init.cpp`
