...
Edit `espnowreceiver_2/lib/webserver/api/api_handlers.cpp`:
...
- API Handlers: `espnowreceiver_2/lib/webserver/api/api_handlers.cpp`
- Type Definitions: Search for `TypeEntry` struct in `api_handlers.cpp`
- Type Mapping Script: `espnowreceiver_2/scripts/sync_type_mappings.py`
