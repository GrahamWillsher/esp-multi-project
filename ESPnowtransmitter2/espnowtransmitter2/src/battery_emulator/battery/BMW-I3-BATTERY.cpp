...
constexpr CAN_frame BmwI3Battery::BMW_192;
constexpr CAN_frame BmwI3Battery::BMW_2CA;
constexpr CAN_frame BmwI3Battery::BMW_2E2;
constexpr CAN_frame BmwI3Battery::BMW_37B;
constexpr CAN_frame BmwI3Battery::BMW_380;
constexpr CAN_frame BmwI3Battery::BMW_3A0;
constexpr CAN_frame BmwI3Battery::BMW_3CA;
constexpr CAN_frame BmwI3Battery::BMW_3D0;
constexpr CAN_frame BmwI3Battery::BMW_3E4;
constexpr CAN_frame BmwI3Battery::BMW_3FB;
constexpr CAN_frame BmwI3Battery::BMW_418;
constexpr CAN_frame BmwI3Battery::BMW_41D;
constexpr CAN_frame BmwI3Battery::BMW_512;
constexpr CAN_frame BmwI3Battery::BMW_592_0;
constexpr CAN_frame BmwI3Battery::BMW_592_1;
constexpr CAN_frame BmwI3Battery::BMW_5F8;
constexpr CAN_frame BmwI3Battery::BMW_6F1_CELL;
constexpr CAN_frame BmwI3Battery::BMW_6F1_SOH;
constexpr CAN_frame BmwI3Battery::BMW_6F1_SOC;
constexpr CAN_frame BmwI3Battery::BMW_6F1_CELL_VOLTAGE_AVG;
constexpr CAN_frame BmwI3Battery::BMW_6F1_CONTINUE;
constexpr CAN_frame BmwI3Battery::BMW_6F1_CLEAR_DTC;
constexpr CAN_frame BmwI3Battery::BMW_6F4_CELL_CONTINUE;
...
void BmwI3Battery::update_values() {  //This function maps all the values fetched via CAN to the battery datalayer
  ...
  if (battery_info_available) {
    // Set cell count (constant for all BMW i3 batteries)
