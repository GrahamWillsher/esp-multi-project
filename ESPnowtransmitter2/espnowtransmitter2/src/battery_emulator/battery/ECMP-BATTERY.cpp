...
constexpr CAN_frame EcmpBattery::ECMP_111;
constexpr CAN_frame EcmpBattery::ECMP_114;
constexpr CAN_frame EcmpBattery::ECMP_0C5;
constexpr CAN_frame EcmpBattery::ECMP_230;
constexpr CAN_frame EcmpBattery::ECMP_382;
constexpr CAN_frame EcmpBattery::ECMP_439;
constexpr CAN_frame EcmpBattery::ECMP_ACK;
constexpr CAN_frame EcmpBattery::ECMP_DIAG_START;
constexpr CAN_frame EcmpBattery::ECMP_CONTACTOR_RESET_START;
constexpr CAN_frame EcmpBattery::ECMP_CONTACTOR_RESET_PROGRESS;
constexpr CAN_frame EcmpBattery::ECMP_COLLISION_RESET_START;
constexpr CAN_frame EcmpBattery::ECMP_COLLISION_RESET_PROGRESS;
constexpr CAN_frame EcmpBattery::ECMP_ISOLATION_RESET_START;
constexpr CAN_frame EcmpBattery::ECMP_ISOLATION_RESET_PROGRESS;
constexpr CAN_frame EcmpBattery::ECMP_RESET_DONE;
constexpr CAN_frame EcmpBattery::ECMP_FACTORY_MODE_ACTIVATION;
constexpr CAN_frame EcmpBattery::ECMP_DISABLE_ISOLATION_REQ;
constexpr CAN_frame EcmpBattery::ECMP_ACK_MESSAGE;
// Note: ECMP_0AE, ECMP_041, and ECMP_786 are inside #ifdef SIMULATE_ENTIRE_VEHICLE_ECMP
// and are not instantiated when that macro is not defined
