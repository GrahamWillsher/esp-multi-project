...
// Note: BMWiX_125, BMWiX_1EA, BMWiX_21D, BMWiX_340, BMWiX_380, BMWiX_442, BMWiX_4EB, BMWiX_4F8 are commented out in header
constexpr CAN_frame BmwIXBattery::BMWiX_188;
constexpr CAN_frame BmwIXBattery::BMWiX_1FC;
constexpr CAN_frame BmwIXBattery::BMWiX_276;
constexpr CAN_frame BmwIXBattery::BMWiX_2ED;
constexpr CAN_frame BmwIXBattery::BMWiX_2F1;
constexpr CAN_frame BmwIXBattery::BMWiX_6D;
constexpr CAN_frame BmwIXBattery::BMWiX_C0;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_ENERGY_SAVING_MODE_STATUS;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_SET_ENERGY_SAVING_MODE_NORMAL;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_SLEEPMODE;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_HARD_RESET;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_CELL_TEMP;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_SOC;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_CAPACITY;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_MINMAXCELLV;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_MAINVOLTAGE_POSTCONTACTOR;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_MAINVOLTAGE_PRECONTACTOR;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_BATTERYCURRENT;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_CELL_VOLTAGE;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_T30VOLTAGE;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_EOL_ISO;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_SOH;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_UPTIME;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_PYRO;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_HVIL;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_MAX_CHARGE_DISCHARGE_AMPS;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_BALANCINGSTATUS;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_PACK_VOLTAGE_LIMITS;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_READ_DTC;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_REQUEST_CLEAR_DTC;
constexpr CAN_frame BmwIXBattery::BMWiX_6F4_CONTINUE_DATA;
constexpr const CAN_frame* BmwIXBattery::UDS_REQUESTS100MS[18];
