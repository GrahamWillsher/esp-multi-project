...
**File:** `espnowreceiver_2/lib/webserver/webserver.cpp`
...
- [ ] **Receiver:** `espnowreceiver_2/lib/webserver/api/api_handlers.cpp`
  - Add `/api/get_event_logs` proxy handler
  - Register handler in array
  
- [ ] **Receiver:** `espnowreceiver_2/lib/webserver/webserver.cpp`
  - Update EXPECTED_HANDLER_COUNT from 57 to 58
  
- [ ] **Receiver:** `espnowreceiver_2/lib/webserver/pages/dashboard_page.cpp`
...
- `espnowreceiver_2/lib/webserver/api/api_handlers.cpp` - Battery type API (reference pattern)

**Dashboard Pattern (Reference):**
- `espnowreceiver_2/lib/webserver/pages/dashboard_page.cpp` - System Tools section exists
