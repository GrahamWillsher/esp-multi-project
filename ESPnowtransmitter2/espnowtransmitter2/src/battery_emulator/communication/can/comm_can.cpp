...
// Global function to register transmitters (called by Battery/Charger/Inverter constructors)
// Transmitters are called periodically to send their CAN messages
static std::vector<Transmitter*> transmitters;
...
// Helper function to get CAN interface name (used for logging and display)
const char* getCANInterfaceName(CAN_Interface interface) {
  switch (interface) {
    case CAN_NATIVE: return "Native CAN";
    case CANFD_NATIVE: return "Native CAN-FD";
    case CAN_ADDON_MCP2515: return "MCP2515";
    case CANFD_ADDON_MCP2518: return "MCP2518";
