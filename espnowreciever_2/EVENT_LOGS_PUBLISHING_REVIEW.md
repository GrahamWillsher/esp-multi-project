...
Source: [espnowreciever_2/src/mqtt/mqtt_client.cpp](espnowreciever_2/src/mqtt/mqtt_client.cpp)
...
**Receiver side:**
- Leverage existing `cell_data_subscribers_` pattern from [espnowreciever_2/src/mqtt/mqtt_client.cpp](espnowreciever_2/src/mqtt/mqtt_client.cpp).
