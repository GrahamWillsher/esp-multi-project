...
**Location:** espnowreciever_2/src/mqtt/mqtt_client.cpp (handleCellData)

Read the `data_source` field and pass to the TransmitterManager cache.

### R2) Store `data_source` in TransmitterManager
**Location:** espnowreciever_2/lib/webserver/utils/transmitter_manager.cpp
...
**Location:** espnowreciever_2/lib/webserver/api/api_handlers.cpp (SSE handler)
...
**Location:** espnowreciever_2/lib/webserver/pages/cellmonitor_page.cpp
