...
/**
 * UPSTREAM BOUNDARY (Section 4.3 — Battery Emulator subtree deduplication)
 *
 * This is the Battery Emulator 9.2.4 upstream datalayer header.
 * A local extended copy exists at src/datalayer/datalayer.h that adds
 * project-local typedef aliases and adjusted include paths.
 *
 * Do NOT edit this file without also updating src/datalayer/datalayer.h.
 */
