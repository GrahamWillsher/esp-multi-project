...
esp_err_t emit_dashboard_page_content(
                    ...
                    <div style='margin: 20px 0; padding: 15px; background: rgba(0,0,0,0.3); border-radius: 8px;'>
                        <div style='display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;'>
                            <div style='display: flex; align-items: center;'>
                                <span id='txStatusDot' style='width: 12px; height: 12px; border-radius: 50%; background: #ff6b35; margin-right: 10px;'></span>
                                <span style='font-weight: bold; color: #FFD700;'>Status:</span>
                            </div>
                            <span id='txStatus' style='color: #ff6b35; font-weight: bold;'>Disconnected</span>
                        </div>
    ...
    <div class='info-box' style='margin-top: 30px; border-top-color: #FF9800;'>
        <h3 style='margin: 0 0 20px 0; color: #FF9800;'><a href='/systemtools' style='color: #FF9800; text-decoration: none;'>&#128295; System Tools</a></h3>
